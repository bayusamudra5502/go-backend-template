...
func (m *MockLogger) Debug(ctx context.Context, text string) {
	m.helper(Debug, text)
}

func (m *MockLogger) Info(ctx context.Context, text string) {
	m.helper(Info, text)
}

func (m *MockLogger) Warning(ctx context.Context, text string) {
	m.helper(Warning, text)
}

func (m *MockLogger) Error(ctx context.Context, text string) {
	m.helper(Error, text)
}
